...
class seederPermissions extends Seeder
{
    ...
    public function run()
    {
        $permissions=[
            ...
            //Permisos para queriePermisoController de zarpes
            'consultar-zarpe',
            'eliminar-zarpe',
            'aprobar-zarpe',
            'rechazar-zarpe',
            ...
            //queriePermisoController para queriePermisoController de estadia
            'crear-estadia',
            ...
            'consultar-estadia',
              ...
              //queriePermisoController para usuarios de capitanias
            ...
            //queriePermisoController para Establecimientos
