                    ...
                    .done(function (response) {
                        ...
                        if (tamano == 0) {
                            ...
                            if (pasajeroExiste == null) {
                                ...
                                if (respuesta.nombre2 == null) {
                                    nombres = respuesta.nombre1;
                                } else {
                                    nombres = respuesta.nombre1 + " " + respuesta.nombre2;
                                }
                                if (respuesta.apellido2 == null) {
                                    apellidos = respuesta.apellido1;
                                } else {
                                    apellidos = respuesta.apellido1 + " " + respuesta.apellido2;
                                }
                                $('#nombres').val(nombres);
    ...
    if (cedula != '' && fechanac != '' && tipodoc == 'V') {
        $.ajax({
            ...
            .done(function (response) {
                ...
                if (pasajeroExiste == null) {
                    let nombres, apellidos;
                    if (respuesta[0].nombre2 == null) {
                        nombres = respuesta[0].nombre1;
                    } else {
                        nombres = respuesta[0].nombre1 + " " + respuesta[0].nombre2;
                    }
                    if (respuesta[0].apellido2 == null) {
                        apellidos = respuesta[0].apellido1;
                    } else {
                        apellidos = respuesta[0].apellido1 + " " + respuesta[0].apellido2;
                    }
                    $('#nombresMenor').val(nombres);
                    $('#apellidosMenor').val(apellidos);
                    $("#sexoMenor > option[value='']").removeAttr("selected");
