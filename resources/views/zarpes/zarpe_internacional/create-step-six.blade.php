        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                        ...
                        <div class="col  my-1 DatosRestantes2">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="nombresMenorTrip" placeholder="Nombres"
                                       name="nombresMenorTrip" maxlength="40">
                            </div>
                        </div>
                        ...
                        <div class="col  my-1 DatosRestantes2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="apellidosMenorTrip" placeholder="Apellidos"
                                       name="apellidosMenorTrip" maxlength="40">
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="btnAdd" class="btn btn-primary" data-ced='' onclick="AddPassengerMenorTrip('ZI')">
                        Agregar
                    </button>
                </div>
            </div>
